def place_order(menu):
    ...
    while True:
        ...
        # (Note: This happens after showing the menu)
        ...
        menu_selection = input("Please enter the item number of the meal you would like to order: ")
        ...
        another = input("Would you like to order anything else? Type 'n' or 'N' to finish ordering: ")
        ...
        if another.lower() == 'n':
            ...
            print("Thanks for your order! Here's your receipt.")
...
def update_order(order, menu_selection, menu_items):
    ...
    if menu_selection.isdigit():
        ...
        print(f"'{menu_selection}' is not a number. Please enter a number from the menu.")
